...
- [x] 32-01-PLAN.md — `edf_lab_e2e`, `playwright.config.pg.js`, `test:e2e:pg`

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 32-02-PLAN.md — Job CI `e2e-postgres`, docs y verificación
...
- [x] 33-01-PLAN.md — Proyectos Firefox + CI `test:e2e:ci` + WebKit local

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 33-02-PLAN.md — Mission 17, NOTEBOOK v2.1, matriz navegadores en docs
