...
- [x] **QA-VIS-02**: React (`:5174`) and Vue (`:5175`) have equivalent visual snapshot specs using the same viewport, auth flow, and comparable UI states as QA-VIS-01.
...
- [x] **AUTH-ADV-01**: OAuth / social login providers
